...
import {
  ...
  Page({
    ...
    cntrSizeRadioChange(e) {
        this.setData({
            CntrSizeCode: parseInt(e.detail.value)
        })
      },
    SaveCar() {
      var thisView = this;
        ...
        success: (res) => {
          ...
          wx.uploadFile({
            ...
            success(res) {
              ...
              if (thisView.data.carphotonum == 5) {
    ...
    getspecifieddata(filePath) {
      var thisView = this;
      var apiUrl = "https://www.xiang-cloud.com/Api/Mini/Rail.ashx?act=OcrBoxPackingRailEmptyDoorPhoto";
      ...
      wx.request({
        ...
        success: function (res) {
          ...
          if (result.ErrorDesc != null && result.ErrorDesc != "") {
            ...
            thisView.setData({
              CntrNo: result.cntrNo,
              CntrSizeCode: result.type
            })
    ...
    getDetailData() {
      ...
      wx.getLocation({
        ...
        success(res) {
          ...
          wx.request({
            url: 'https://www.xiang-cloud.com/Api/Mini/Rail.ashx?act=GetPhotoPackingRailEmpty',
            data: {
              id: that.data.thisId,
            ...
            success: function (res) {
              ...
              that.setData({
                ...
                Id: rtn.data.Id,
                truckPic: rtn.data.TruckPic == null ? '' : rtn.data.TruckPic,
                container1Pic: rtn.data.Container1Pic == null ? '' : rtn.data.Container1Pic,
                tailTruckPic: rtn.data.TailTruckPic == null ? '' : rtn.data.TailTruckPic
              });
              ...
              that.setData({
                navbarTitle:'苏州班列空箱' + that.data.InOrOut
              });
            },
            fail: function (res) {
              wx.hideLoading()
